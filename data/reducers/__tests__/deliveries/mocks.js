...
export const fetchDeliveriesRequestAction = () => ({
  type: FETCH_BUSINESS_DELIVERIES_REQUEST
});

export const fetchDeliveriesSuccessAction = ({ page }) =>
  page === 1
    ? {
        type: FETCH_BUSINESS_DELIVERIES_SUCCESS,
        payload: {
          data: {
            deliveries: {
...
export const fetchDeliveriesFailAction = ({ page }) => ({
  type: FETCH_BUSINESS_DELIVERIES_FAIL,
  meta: { page }
});

export const postDeliverySuccessAction = () => ({
...
export const deleteDeliveryRequestAction = id => ({
