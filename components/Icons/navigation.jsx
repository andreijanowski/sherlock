...
export const Fork = () => (
  ...
  >
    ...
    <path
      className="svg-fork-cls"
      d="M173.1,114.5c-4.5,0-8.1,3.7-8.1,8.1v111.9c0,4.5,3.7,8.1,8.1,8.1s8.1-3.7,8.1-8.1V122.6
C181.3,118.2,177.6,114.5,173.1,114.5z"
    />
    <path
      className="svg-fork-cls"
      d="M224.9,114.5c-4.5,0-8.1,3.7-8.1,8.1v111.9c0,4.5,3.7,8.1,8.1,8.1c4.5,0,8.1-3.7,8.1-8.1V122.6
C233,118.2,229.3,114.5,224.9,114.5z"
    />
    <path
      className="svg-fork-cls"
      d="M199,0C89.3,0,0,89.3,0,199c0,98.4,71.7,180.2,165.6,196.2v111c0,16.5,13.5,29.9,29.9,29.9h7.8
